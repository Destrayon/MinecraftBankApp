    ...
    public static class Client
    {
        ...
        private static void CommandLoop()
        {
            while (true)
            {
                ...
                permission = int.Parse(Encoding.ASCII.GetString(SendRequest($"5 {username}")));
                string ans = ClientCommands.Commands(cmd, username, permission);

                if (ans == "Invalid command")
                {
        ...
        private static void SignUp()
        {
            ...
            else
            {
                ...
                username = un;
                permission = int.Parse(Encoding.ASCII.GetString(SendRequest($"5 {un}")));
            }
        }
        ...
        public static byte[] SendRequest(string s)
        {
